      ...
      <Row>
        ...
        >
          ...
          >
            Marcos
            <br />
            Araújo <span style={{ color: "#E4AA48" }}>.</span>
          </h1>
          <div className="dash"></div>
          <p className="col-1-job" style={{ marginTop: "0.8rem" }}>
          ...
          >
            <Link
              ...
              to={"https://www.instagram.com/__marcos.vinicius/"}
            >
              <svg
                className="nav-icon"
            ...
            <Link
              target="blank"
              className="nav-link nav-icon"
              to={"https://www.linkedin.com/in/marcosvinalves/"}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
            ...
            <Link
              target="blank"
              className="nav-link nav-icon"
              to={"https://github.com/marcosvinalves"}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
        ...
        <Col
          className="third-col col-xl-4 col-lg-4 col-md-4 col-sm-8 col-8"
          style={{ gap: "0.8rem" }}
        >
          <p
            style={{
          ...
          <h1 style={{ color: "#dadada", fontWeight: "bold" }}>
            UX Designer,
            <br /> Front-end Web Developer
          </h1>
          <p style={{ color: "#dadada", fontSize: "1rem" }}>
